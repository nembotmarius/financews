...
import com.nembotmarius.financeweb.clients1.exception.AuthenticationFail;
import com.nembotmarius.financeweb.clients1.exception.Deletewithwrongid;
import com.nembotmarius.financeweb.clients1.exception.NotFoundException;
import com.nembotmarius.financeweb.clients1.exception.PaclieUpdatewithwrongPaclieid;
import com.nembotmarius.financeweb.clients1.repository.PaclieRepository;
import com.nembotmarius.financeweb.clients1.repository.ScsessRepository;
import com.nembotmarius.financeweb.clients1.utils.Utils;
...
public class PaclieServiceImpl implements PaclieService {
    ...
    public Collection<PaclieEntity> getAllPaclies(@NonNull String user, @NonNull String token) {
        ...
        //recherche tous les clients1 de la base
        Collection<PaclieEntity> paclieList = paclierepository.findAllPaclie();
        //si tout est bon je retourne la liste des clients1
        return paclieList;
    }
    ...
    public List<PaclieRepository.Compte> getAllCollecteCompte(String user, String token, String stauto) {
        ...
        if(o.isNumeric(stauto)){
            ...
            if(lstcomptes != null){
                //une fois trouver retourner le clients1
                return lstcomptes;
            }else{
    ...
    public PaclieEntity updatePaclie(@NonNull String user, @NonNull String token, @NonNull String id, @NonNull PaclieEntity paclieentity) {
        ...
        //sinon verifie si id et l'id du clients1 a modifié sont differents
            //si oui
                // renvoyer une exception avec le code 404 avec message d'erreur
            //sinon verifie si le movie a modifier existe bien dans la base, avant d'envisager de changer
                ...
                //si existe
                    // prendre ce clients1 et remplacer avec les informations à changer par les nouvelles valeurs
        ...
        if(paclieentitytoupdate==null){
            throw new PaclieUpdatewithwrongPaclieid("Le clients1 n'existe pas dans la base");
        }
    ...
    public PaclieEntity deletePaclie(@NonNull String user, @NonNull String token, @NonNull String id) {
        ...
        if(paclieentitytodelete==null){
            throw new Deletewithwrongid("Le clients1 n'existe pas dans la base");
        }
